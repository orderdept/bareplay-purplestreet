# BarePlay Email Hosted

Hosted BarePlay email control panel for `bareplay-email.purplestreet.com`.

This project is intentionally separate from any live local sender. Local tools remain the active operational system until the hosted rebuild is fully tested and you decide to switch.
...
- BarePlay email control panel only
...
- first module route created for BarePlay email
