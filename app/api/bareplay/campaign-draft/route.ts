...
import { type CampaignDraft } from "../../../../lib/bareplay-types";
...
export async function POST(request: Request) {
  try {
    ...
    const draft: CampaignDraft = {
      ...
      smtpUsername:
        typeof body.smtpUsername === "string" ? body.smtpUsername.trim().toLowerCase() : "info@bareplay.org",
      fromName: typeof body.fromName === "string" ? body.fromName.trim() : "BarePlay",
      dailyLimit:
